                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                value="<%= u != null ? (u.getName() != null ? u.getName() : "") : "" %>" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="email">Email</label>
                            <input type="email" class="form-control" id="email" name="email"
                                value="<%= u != null ? (u.getEmail() != null ? u.getEmail() : "") : "" %>" readonly>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="mobile" name="mobile"
                                value="<%= u != null ? (u.getPhno() != null ? u.getPhno() : "") : "" %>" readonly>
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="landmark" name="landmark"
                                value="<%= u != null ? (u.getLandmark() != null ? u.getLandmark() : "") : "" %>" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="city">City</label>
                            <input type="text" class="form-control" id="city" name="city"
                                value="<%= u != null ? (u.getCity() != null ? u.getCity() : "") : "" %>" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="state" name="state"
                                value="<%= u != null ? (u.getState() != null ? u.getState() : "") : "" %>" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="pincode">Pincode</label>
                            <input type="text" class="form-control" id="pincode" name="pincode"
                                value="<%= u != null ? (u.getPincode() != null ? u.getPincode() : "") : "" %>" required>
                        </div>
                    </div>
