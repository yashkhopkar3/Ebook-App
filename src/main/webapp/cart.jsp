...
<%@include file="All_Component/Navbar.jsp"%>
    <div class="container mt-8">
        <div class="row">
            <div class="col-md-7 card-container margin-bottom">
                <h3>Shopping Cart</h3>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><%=item.getPrice()%></td>
                            <td><a href="removeCart?cid=<%=item.getCid()%>" class="btn btn-danger">Remove</a></td>
                        </tr>
                        <%
                            }
                        } else {
            ...
            <div class="col-md-4 card-container margin-bottom">
                ...
                <form action="order" method="post">
                    ...
                    <button type="submit" class="btn btn-warning btn-custom">Order Now</button>
