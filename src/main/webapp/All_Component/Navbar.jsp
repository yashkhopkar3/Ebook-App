...
<div class="container-fluid p-3">
    <div class="row">
        ...
        <div class="col-md-3 text-right">
            <a href="#" class="btn btn-outline-success"><i class="fa-solid fa-right-to-bracket"></i> Login</a>
            <a href="#" class="btn btn-outline-primary"><i class="fa-solid fa-user"></i>  Register</a>
        </div>
    </div>
</div>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#"><i class="fa-solid fa-book-open-reader"></i> Recent</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#"><i class="fa-solid fa-book-open"></i> Old Books</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#"><i class="fa-solid fa-plane-arrival"></i> New Arrivals</a>
            </li>
            <li class="nav-item">
