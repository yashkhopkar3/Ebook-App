						...
						<form action="../edit_books" method="post">
							...
							<div class="mb-3">
								<label for="authorName" class="form-label">Author Name</label> <input
									...
									name="authorName" value="<%=b.getAuthor()%>" required>
							</div>
							...
							<div class="mb-3">
								<label for="bookCategories" class="form-label">Book
									...
									<option value="Autobiography"
										<%="Autobiography".equals(b.getBookCategory()) ? "selected" : ""%>>Autobiography</option>
									<option value="History"
										<%="History".equals(b.getBookCategory()) ? "selected" : ""%>>History</option>
									<option value="Humor"
										<%="Humor".equals(b.getBookCategory()) ? "selected" : ""%>>Humor</option>
									<option value="Mystery"
										<%="Mystery".equals(b.getBookCategory()) ? "selected" : ""%>>Mystery</option>
									<option value="Romantic"
										<%="Romantic".equals(b.getBookCategory()) ? "selected" : ""%>>Romantic</option>
								</select>
							</div>
							...
							<div class="mb-3">
								...
								<input type="number" class="form-control" id="copies" value="<%=b.getCopies()%>"
